...
public interface ISBObject {
    ...
    Command MoveX(Easing easing, long time, double startX, double endX);
    Command MoveX(long time, double startX, double endX);
    Command MoveX(Easing easing, long startTime, long endTime, double x);
    Command MoveX(long startTime, long endTime, double x);
    Command MoveX(Easing easing, long time, double x);
    Command MoveX(long time, double x);
